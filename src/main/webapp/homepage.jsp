...
<%--                <li class="nav-item"><a class="nav-link mnu-itm" style="color: #ffffff" href="categories.jsp">Add Category</a> </li>--%>
<%--                <li class="nav-item"><a class="nav-link mnu-itm" style="color: #ffffff" href="productAdd.jsp">Add Product</a> </li>--%>

<%--            </c:if>--%>

<%--            <li class="nav-item"><a class="nav-link mnu-itm" style="color: #ffffff" href="categoryList.jsp">View Categories</a> </li>--%>
...
<%--                <li class="nav-item"><a class="nav-link mnu-itm" style="color: #ffffff" href="employeeList.jsp">Manage Employees</a> </li>--%>
<%--            </c:if>--%>
<%--            <c:if test="${auth.getRole().equals('Customer')}">--%>
...
<%--            </c:if>--%>
<%--            <c:if test="${auth.getRole().equals('Admin')}">--%>
<%--                <li class="nav-item"><a class="nav-link mnu-itm" style="color: #ffffff" href="reports.jsp">Reports</a> </li>--%>
<%--            </c:if>--%>
<%--        </ul>--%>
...
<%--                </c:if>--%>
<%--                <li class="nav-item"><a class="nav-link mnu-itm" href="changePassword.jsp"><i class="fa fa-lock"--%>
...
<div id="carouselExampleInterval" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner" data-interval="500">
        <div class="carousel-item active">
            <img src="https://source.unsplash.com/1600x900/?watches" class="d-block w-200" alt="Image1">
        </div>
        <div class="carousel-item" data-interval="500">
            <img src="https://source.unsplash.com/1600x900/?shoes" class="d-block w-200" alt="Image2">
        </div>
        <div class="carousel-item"data-interval="500">
            <img src="https://source.unsplash.com/1600x900/?clothes" class="d-block w-200" alt="Image3">
        </div>
        <div class="carousel-item"data-interval="500">
            <img src="https://source.unsplash.com/1600x900/?bags" class="d-block w-200" alt="Image4">
        </div>
        <div class="carousel-item"data-interval="500">
            <img src="https://source.unsplash.com/1600x900/?toys" class="d-block w-200" alt="Image5">
        </div>
    </div>
</div>
